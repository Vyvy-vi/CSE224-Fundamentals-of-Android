...
if the value is null.If anyone want NullPointerException
 ...
 it needs to be thrown explicitly null pointer exception
  ...
  one line. As you won't to be able to say which
  one cause the exception

  -->instead of this prefer to use safe access "?." operator OR
  elvis operatioor"?:" OR if-else statements*/
