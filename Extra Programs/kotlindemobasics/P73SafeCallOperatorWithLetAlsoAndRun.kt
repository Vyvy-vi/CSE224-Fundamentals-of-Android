...
/*Safe Call operator:if there are more number of variables
...
fun main()
{
 ...
 -->"let{}" with safe call operator.let{}(in the curly
    ...
    some additional operation like printing the non-nullable
     items of the list we can use an also() method and chain
...
similar to let() but inside of a function body, the run()
